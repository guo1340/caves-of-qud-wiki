  ...
  "categories": [
    {
      ...
      "icon": "compass",
      "summary": "Starting choices, water economy, first village routes, combat basics and early mistakes."
    },
    {
      "id": "mutations",
      "title": "Mutations",
    ...
    },
    {
      ...
      "icon": "profile",
      "summary": "Beginner builds, Esper builds, True Kin builds, gunslingers, tinkers and hybrids."
    },
    {
      "id": "skills",
      "title": "Skills",
      "icon": "nodes",
      "summary": "Skill trees, costs, progression paths, combat skills, merchanting and tinkering."
    },
    {
      "id": "cybernetics",
      "title": "Cybernetics",
      "icon": "chip",
      "summary": "Implants, slots, True Kin economy, farming routes and cybernetic tier advice."
    },
    {
      "id": "factions",
      "title": "Factions",
      "icon": "sigil",
      "summary": "Reputation, water rituals, alliances, hostility and faction-specific rewards."
    },
    {
      "id": "maps",
      "title": "Maps & Regions",
      "icon": "map",
      "summary": "Joppa, Six Day Stilt, Golgotha, Bethesda Susa, jungles, marshes and ruins."
    },
    {
      "id": "items",
      "title": "Items",
      "icon": "cube",
      "summary": "Weapons, armor, artifacts, relics, injectors, grenades, tonics and trade goods."
    },
    {
      "id": "creatures",
      "title": "Creatures",
      "icon": "eye",
      "summary": "Threat levels, biomes, resistances, weaknesses, loot and special attacks."
    },
    {
      "id": "lore",
      "title": "Lore",
      "icon": "scroll",
      "summary": "Sultan histories, ancient civilizations, religious groups, ruins and impossible records."
    },
    {
      "id": "mods",
      "title": "Mods",
      "icon": "gear",
      "summary": "Best mods, UI mods, QoL mods, content mods, compatibility and installation."
    },
    {
      "id": "updates",
      "title": "Updates",
      "icon": "signal",
      "summary": "Patch notes, version changes, developer news and compatibility watchpoints."
    }
  ],
  "facts": [
